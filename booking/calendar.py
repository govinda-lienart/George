    ...
    if user_input:
        ...
        if st.session_state.booking_mode:
            st.session_state.history.append(
                ("bot", "The booking form has been triggered. Please fill out the required details to proceed with your hotel reservation. Let me know if you need any assistance during the process!")
            )
